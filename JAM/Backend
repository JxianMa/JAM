    ...
    private static void init() throws Exception {
        ...
        try {
            ...
            throw new AmazonClientException(
                    ...
                    "location (/home/madhurima/.aws/credentials), and is in valid format.",
                    e);
        }
        ...
        try {
            ...
            if (Tables.doesTableExist(dynamoDB, tableName)) {
                ...
                CreateTableRequest createTableRequest = new CreateTableRequest().withTableName(tableName)
                    .withKeySchema(new KeySchemaElement().withAttributeName("storyID").withKeyType(KeyType.HASH))
                    .withAttributeDefinitions(new AttributeDefinition().withAttributeName("storyID").withAttributeType(ScalarAttributeType.N))
            ...
            // Add an item
            Map<String, AttributeValue> item = newItem(id1, "JAM", "This is JAM", b, inputTimestamp, inputTimestamp, d1, d2);
...
//            System.out.println("Result: " + scanResult);
    ...
    private static Map<String, AttributeValue> newItem(int id, String name, String desc, ByteBuffer image, Timestamp storyTime, Timestamp currentTime, double lati, double longi) {
